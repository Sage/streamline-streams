...
function consoleSink(name) {
	return exports.sink(function(_, value) {
		console[name](value);
	});
}
...
exports.stdin = function(encoding) {
	var st = new exports.ReadableStream(process.stdin);
	st.setEncoding(encoding);
	process.stdin.resume();
	return st;
}

exports.stdout = function(encoding) {
	return new exports.WritableStream(process.stdout, {
		encoding: encoding
	})
}

exports.stderr = function(encoding) {
	return new exports.WritableStream(process.stderr, {
		encoding: encoding
	})
}
